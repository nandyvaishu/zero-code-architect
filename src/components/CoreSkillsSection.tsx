...
const CoreSkillsSection = () => {
  const codepenProjects: CodepenProject[] = [
    ...
    },
    {
      ...
      thumbnail: "https://i.ibb.co/yn4TfPY7/In-Shot-20250519-200618171.jpg",
  ...
  return (
    <section id="core-skills" className="py-20 relative bg-gray-50 dark:bg-gray-900">
      ...
      <div className="absolute inset-0 overflow-hidden z-0">
        <div className="absolute top-1/4 right-1/4 w-32 h-32 bg-customBlue-100 dark:bg-customBlue-900/20 rounded-full opacity-20 dark:opacity-10 blur-2xl" />
        <div className="absolute bottom-1/4 left-1/4 w-48 h-48 bg-customBlue-100 dark:bg-customBlue-900/20 rounded-full opacity-20 dark:opacity-10 blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            I've built over 10+ mini-projects on CodePen using HTML, CSS, JavaScript, and Bootstrap during my learning
            phase. These projects were focused on UI/UX, responsiveness, and DOM-based interactivity. This foundational
            work ensures I don't rely solely on no-code tools — I understand the fundamentals deeply.
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {codepenProjects.map((project, index) => (
            <a href={project.url} target="_blank" rel="noopener noreferrer" key={index} className="group block">
              <Card className="h-full border-none shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden dark:bg-gray-800/70">
                <div className="relative aspect-[4/3] overflow-hidden bg-white dark:bg-gray-900 p-2">
                    ...
                    <div className="flex flex-wrap gap-1 translate-y-4 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                      {project.tags.map((tag, i) => (
                        <Badge
                          key={i}
                          variant="outline"
                          className="bg-white/90 dark:bg-gray-900/90 dark:text-white text-xs"
                        >
                          {tag}
                        </Badge>
                      ))}
        ...
        <div className="mt-8 text-center">
          ...
          <div className="mt-6">
            <Button
              asChild
              variant="outline"
              className="group hover:bg-customBlue-50 hover:text-customBlue-600 dark:hover:bg-customBlue-900/30 dark:hover:text-customBlue-400 hover:border-customBlue-200 dark:border-gray-700"
            >
