...
const HeroSection = () => {
  return (
    <section id="home" className="min-h-screen flex items-center pt-16 pb-12 overflow-hidden relative">
      ...
      <div className="absolute -top-24 -left-24 w-96 h-96 bg-customGreen-50 rounded-full opacity-60 blur-3xl animate-pulse"></div>
      <div className="absolute bottom-12 -right-12 w-80 h-80 bg-customGreen-50 rounded-full opacity-60 blur-3xl"></div>
      <div className="absolute top-1/3 right-1/4 w-20 h-20 bg-customGreen-100 rounded-full opacity-40 blur-xl"></div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="lg:w-1/2">
            <div className="flex items-center mb-3">
              <span className="bg-customGreen-100 text-customGreen-600 text-xs font-medium px-3 py-1 rounded-full">Prompt Engineer & No-Code Builder</span>
            </div>
            ...
            <div className="mt-12 flex flex-wrap gap-6">
              <div className="flex items-center text-sm text-gray-500">
                <Wand2 className="h-4 w-4 mr-2 text-customGreen-500" />
                <span>Prompt Engineering</span>
              </div>
              <div className="flex items-center text-sm text-gray-500">
                <Code className="h-4 w-4 mr-2 text-customGreen-500" />
                <span>No-Code Development</span>
              </div>
              <div className="flex items-center text-sm text-gray-500">
                <Palette className="h-4 w-4 mr-2 text-customGreen-500" />
                <span>UI/UX Design</span>
              </div>
              <div className="flex items-center text-sm text-gray-500">
                <Zap className="h-4 w-4 mr-2 text-customGreen-500" />
          ...
          <div className="lg:w-1/2 animate-scale-in">
            <div className="relative perspective-1000">
              <div className="absolute inset-0 bg-gradient-to-br from-customGreen-400/20 to-customGreen-600/20 blur-xl rounded-full transform rotate-12"></div>
                ...
                <div className="bg-white rounded-lg p-6 md:p-8 transform hover:-rotate-1 transition-transform">
                  ...
                  <div className="space-y-3">
                    <div className="flex">
                      ...
                      <div className="h-4 bg-customGreen-100 rounded flex-1"></div>
                    </div>
                    <div className="flex">
                      <div className="w-16 bg-gray-100 h-4 mr-2"></div>
                    ...
                    <div className="h-4 bg-customGreen-100 rounded w-5/6 ml-6"></div>
                  </div>
                  
                  <div className="mt-6 flex justify-between">
                    <div className="h-8 bg-customGreen-500 rounded w-1/3 flex items-center justify-center text-white text-xs">Generate</div>
              ...
              {/* AI badge */}
              <div className="absolute -bottom-6 -right-6 w-28 h-28 bg-white rounded-full border border-customGreen-200 flex items-center justify-center z-10 shadow-lg transform hover:rotate-12 transition-transform">
                <div className="text-center animate-pulse">
                  <div className="text-xs text-gray-500">powered by</div>
                  <div className="font-bold text-customGreen-500 tracking-wide text-lg">AI + Prompts</div>
                </div>
              </div>
              
              {/* Floating elements */}
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-customGreen-100 rounded-lg flex items-center justify-center shadow-sm transform rotate-12 animate-bounce" style={{animationDuration: "3s"}}>
                <Wand2 className="h-6 w-6 text-customGreen-500" />
              </div>
            </div>
          </div>
        </div>
